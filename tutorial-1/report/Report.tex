...
%% Task 3.1
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Task 3.1 Simplified Car-Like Robot Model}
%
...
%% Task 3.2
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Task 3.2 Pose Determination from Kinematics Model}
...
Finding $\Delta \theta$ with respect to time $t_1$ and $t_2$.
%
\begin{align*}
...
%
Finding $\Delta x$ with respect to time $t_1$ and $t_2$.
%
\begin{align*}
...
\end{align*}
%
Using $\theta(t_1)$ and $\theta(t_2)$ as lower and upper bounds and substituding $u$ and $du$, 
\begin{align*}
...
%
Finding $\Delta y$ with respect to time $t_1$ and $t_2$.
%
\begin{align*}
...
\end{align*}
%
Since $\Delta \theta$ is 0, $\theta(t)$ remains constant.
